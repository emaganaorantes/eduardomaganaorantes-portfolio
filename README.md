...
| ------- | ----------- | ------------ |
| [Water Bottle Rocket Trajectory Simulation](./final-project.m/) | Models and simulates the flight dynamics of a water bottle rocket using physics-based equations of motion. Incorporates thrust generation, mass variation, aerodynamic drag, and internal pressure changes during propulsion. Uses numerical integration (MATLAB ODE solvers) to predict trajectory and compares results with experimental launch data to evaluate model accuracy and identify sources of error. | MATLAB |
